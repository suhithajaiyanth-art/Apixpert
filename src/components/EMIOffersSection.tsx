...
const EMIOffersSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-10 px-3 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-6 items-stretch">
          ...
          <motion.div
            ...
            className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-6 md:p-8 shadow-2xl overflow-hidden group"
          >
            {/* Gradient Overlay */}
            ...
            <div className="relative z-10 space-y-4">
              ...
              >
                ...
                <p className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-secondary via-primary to-accent bg-clip-text text-transparent mb-2">
                  ₹1055
                </p>
              ...
              >
                <Button 
                  className="w-full bg-gradient-to-r from-secondary to-primary hover:opacity-90 text-white font-semibold py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group/btn"
                >
                ...
                <Button 
                  className="w-full bg-black text-white hover:bg-gray-900 border-2 border-white/20 font-semibold py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                  asChild
                >
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <motion.div
                ...
                className="relative bg-gradient-to-br from-secondary/10 to-secondary/5 border-2 border-secondary/20 rounded-2xl p-4 shadow-lg hover:shadow-2xl transition-all duration-300 group/card overflow-hidden"
              >
                {/* Popular Badge */}
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-foreground pr-10">
              ...
              <motion.div
                ...
                transition={{ duration: 0.8, delay: 0.4 }}
                whileHover={{ scale: 1.05, y: -5 }}
                className="relative bg-gradient-to-br from-primary/10 to-accent/5 border-2 border-primary/20 rounded-2xl p-4 shadow-lg hover:shadow-2xl transition-all duration-300 group/card overflow-hidden"
              >
                {/* Popular Badge */}
                <div className="absolute top-4 right-4 bg-gradient-to-r from-primary to-accent text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                  <Sparkles className="w-3 h-3 inline mr-1" />
